...
<section class="tm-section">
    <div class="container-fluid" style="margin-top: -60px">
        <div class="row">
            <form method="post" action="edit-save.php?id=<?php echo $id?>" enctype="multipart/form-data">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <textarea id="content" name="content" required="required"
                                      style="width:700px;height:450px;"><?php echo $content ?></textarea>
                        </td>
                    </tr>
                </table>
                <div style="text-align: center;width: 75%">
                    <button class="btn btn-primary" type="submit">保存修改</button>
                    <button class="btn btn-primary" type="button" onclick="window.location='myblog.php'">取消修改
                    </button>
                </div>
